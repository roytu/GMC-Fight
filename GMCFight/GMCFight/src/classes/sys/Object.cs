    ...
    public abstract class Object
    {
        ...
        protected bool isCollidingAt(double x, double y, Type obj)
        {
            for (int i = 0; i < Game1.hObjCont.objectArray.Count; i++)
            {
                ...
                {
                    double x11 = x + bbox.Left;
                    double y11 = y + bbox.Top;
                    double x12 = x + bbox.Left + bbox.Width;
                    double y12 = y + bbox.Top + bbox.Height;
                    double x21 = _o.x + _o.bbox.Left;
                    double y21 = _o.y + _o.bbox.Top;
                    double x22 = _o.x + _o.bbox.Left + _o.bbox.Width;
                    double y22 = _o.y + _o.bbox.Top + _o.bbox.Height;
        ...
        protected bool isCollidingAt(double x, double y, Predicate<Object> del)
        {
            for (int i = 0; i < Game1.hObjCont.objectArray.Count; i++)
            {
                ...
                if (del.Invoke(_o))
                {
                    ...
                    double x22 = _o.x + _o.bbox.X + bbox.Width;
                    double y22 = _o.y + _o.bbox.Y + bbox.Height;
                    if (((x21 < x11 && x11 < x22) || (x21 < x12 && x12 < x22)) && ((y21 < y11 && y11 < y22) || (y21 < y12 && y12 < y22)))
                    {
                        return true;
                    }
